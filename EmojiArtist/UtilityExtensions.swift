...
// NSItemProvider is a holdover from the Objective-C
// thus it's recommended to accept that these loadObjects functions will work and move on
// it's a rare case where trying to dive in and understand what's going on here
// would probably not be a very efficient use of the time to learn SwiftUI for now
// (though I'm certainly not going to say I shouldn't)
// (just trying to help to optimize the valuable time for SwiftUI for this project)
